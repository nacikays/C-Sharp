...
namespace ToDo_Uygulaması
{
    public class Board
    {
        ...
        public Board()
        {
            kisiler.Add(0, "Naci KAYSI");
            kisiler.Add(1, "Ahmet KAYA");
            kisiler.Add(2, "CAN OZAN");
            kisiler.Add(3, "Emir CAN");
            kisiler.Add(4, "Oğuzhan KOÇ");

            TODO.Add(new Kart("Yemek Yap", "Çiğ Köfte", "Naci KAYSI",Kart.Buyuluk.M));
            INPROGRESS.Add(new Kart("Temizlik", "Camlari Sil", "Ahmet KAYA",Kart.Buyuluk.S));
            DONE.Add(new Kart("Spor", "Fitness Yap", "CAN OZAN",Kart.Buyuluk.L));
            DONE.Add(new Kart("Ev", "Alisveris Yap", "Emir CAN",Kart.Buyuluk.XL));
            INPROGRESS.Add(new Kart("Temizlik", "Toz Al", "Oğuzhan KOÇ", Kart.Buyuluk.XS));
        }
        ...
        {
            Console.WriteLine("Kart Guncelle Çalışıyor.");
        }
        ...
        private void KartEkle(Kart kart,ref List<Kart> addList,ref List<Kart> deleteList)
        {
            ...
            Console.WriteLine("Taşıma islemi basarili!");
        }
