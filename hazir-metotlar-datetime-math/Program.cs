...
namespace hazir_metotlar_datetime_math
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Math.Log(9)); // 9 un e tabanındaki logaritmiklik karşılığını getirir
            Console.WriteLine(Math.Exp(3)); // e üzeri 3 ü verir.
            Console.WriteLine(Math.Log(10)); // 10 sayısının logaritma 10 tabanındaki karşılığı
